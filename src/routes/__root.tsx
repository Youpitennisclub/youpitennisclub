...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Fun, international tennis lessons in Berlin for all players. All levels, all languages — book your first session today." },
      { name: "author", content: "Youpi Tennis Club" },
      { property: "og:title", content: "Youpi Multi Culti Tennis — Tennis lessons in Berlin" },
      { property: "og:description", content: "Fun, international tennis lessons in Berlin for all players. All levels, all languages — book your first session today." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "Youpi Tennis Club" },
